      ...
      <div className="row appointment-form">
        <div className="col-md-6 px-0">
          <div className="form-content d-flex flex-column justify-content-center align-items-center">
            ...
            <p>
              Please fill in this form in order to book an appointment with our
              specialist. Mandatory fields are marked with an asterisk (*).
            </p>
            <img
              src="https://res.cloudinary.com/dxsom7jmx/image/upload/v1677589027/undraw_medicine_b-1-ol_qujgrp.svg"
              alt=""
        ...
        <div className="col-md-6 d-flex flex-column justify-content-center">
          <form className="container px-md-5">
            <div className="form-group mb-2">
              <label htmlFor="full-time" className="appointment-label">
                Full name
            ...
            <button
              type="button"
              className="mt-4 btn btn-success d-block w-100 rounded-pill"
            >
              Book Appointment
            </button>
          </form>
