      ...
      <div className="row log-container">
        ...
        <div className="col-md-6">
          <div className="login-content d-flex flex-column justify-content-center align-items-center">
            <img className="log-img img-fluid" src="https://res.cloudinary.com/dxsom7jmx/image/upload/v1677768358/undraw_welcome_re_h3d9_e8aywj.svg" alt="" />
          <h4>Log in</h4>
          </div>
        </div>
        ...
        <form className="d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="form-group mb-3">
            ...
            <button type="button" className="btn btn-success d-block w-100 rounded-pill" onClick={handleSubmit}>Login</button>
        </form>
